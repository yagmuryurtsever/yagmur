...
(function($) {
	...
	function SlideToAbout(){
		...
		$('nav a.to-right .arrow-label').html("BEMAR");
	...
	function SlideToContact(){
		...
		$('nav a.to-left .arrow-label').html("BEMAR");
	...
	function SlideToHome(){
		...
		$('nav a.to-left .arrow-label').html("HAKKIMIZDA");
	...
	$(window).load(function(e) {
		...
		var showContent = setTimeout(function(){
			...
			$("#wordrotator").wordsrotator({
    			...
    			words: ['ARCHICAD & AutoCAD <br><span class="highlight"> 3D STUDIO MAX & REVIT </span><br> SOLIDWORKS & PHOTOSHOP',
				'VRAY & SAP2000 & STA4CAD <br> <span class="highlight"> IDECAD & DIŞ TİCARET </span><br> MUHASEBE & NETSIS',
				'GRAFİK WEB TASARIM <br> <span class="highlight">İNSAN KAYNAKLARI</span>']  	//-- Array of words, it may contain HTML values
			});
